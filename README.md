...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3943&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/iris-ued-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `iris-ued` can be installed with `conda`:
...
```
mamba install iris-ued
```

It is possible to list all of the versions of `iris-ued` available on your platform with `conda`:
...
```
mamba search iris-ued --channel conda-forge
```
...
mamba repoquery search iris-ued --channel conda-forge

# List packages depending on `iris-ued`:
mamba repoquery whoneeds iris-ued --channel conda-forge

# List dependencies of `iris-ued`:
mamba repoquery depends iris-ued --channel conda-forge
```
